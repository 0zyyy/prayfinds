...
<!--            <ChevronUpDownIcon-->
            ...
            <div id="deskripsi">
              ...
              <textarea v-model="editedProduct.deskripsi" id="deskrip" placeholder="Deskripsi Produk"
                        class="textarea-bordered border border-orange rounded-md textarea-md block w-full py-3 pl-5 mt-1"></textarea>
            </div>
            <div id="diskon">
              <label for="diskon_produk" class="block mb-3 font-semibold text-blue text-md mt-4 text-left">Diskon
                Produk</label>
              <input id="diskon-produk" type="number"
                     name="diskon"
                     max="100"
                     min="0"
                     v-model="editedProduct.diskon"
                     class="block w-full py-3 pl-5 mt-1 border border-orange rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"/>
            </div>
            <div id="stock">
...
async function storeProduct() {
  ...
  formData.append('discount', editedProduct.value.diskon);
  formData.append('deskripsi', editedProduct.value.deskripsi);
...
onMounted(() => {
  nextTick(async () => {
    ...
    document.getElementById("deskrip").setAttribute("placeholder", data.value.deskripsi);
    ...
    editedProduct.value.deskripsi = data.value.deskripsi;
    editedProduct.value.diskon = data.value.amount_discount;
